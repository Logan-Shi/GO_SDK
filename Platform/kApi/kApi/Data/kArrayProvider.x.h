 ...
 *
 * @internal
 * Copyright (C) 2020 by LMI Technologies Inc.
...
{   
    kStatus (kCall* VDefaultConstruct)(kArrayProvider* provider, kAlloc objectAlloc, kAlloc valueAlloc);
...
kInlineFx(kStatus) xkArrayProvider_VDefaultConstruct(kArrayProvider* provider, kAlloc objectAlloc, kAlloc valueAlloc)
{
