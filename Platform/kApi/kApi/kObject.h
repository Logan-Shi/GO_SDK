 ...
 * 
 * To support cloning, derived classes should override the kObject_VInitCloneEx method. 
 * 
 ...
 * 
 * This method can be overridden in derived classes to support the kObject_Clone overload with 
 * a data allocator argument.   
 * 
 ...
 * @return                  Operation status.  
*/
kInlineFx(kStatus) kObject_VInitCloneEx(kObject object, kObject source, kAlloc objectAllocator, kAlloc valueAllocator, kObject context)
{
