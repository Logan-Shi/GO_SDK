...
typedef struct kObjectVTable
{
    ...
    kStatus (kCall* VInitCloneEx)(kObject object, kObject source, kAlloc objectAllocator, kAlloc valueAllocator, kObject context); 
...
//[Deprecated] Implement VInitCloneEx instead
